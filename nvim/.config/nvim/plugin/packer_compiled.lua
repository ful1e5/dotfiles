...
_G.packer_plugins = {
  ...
  ["nvim-cmp"] = {
    after = { "cmp-nvim-lua", "cmp-path", "cmp_luasnip", "cmp-buffer", "nvim-autopairs" },
...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'nvim-surround', 'gitsigns.nvim', 'Comment.nvim', 'vim-fugitive', 'nvim-treesitter', 'nvim-cmp', 'mason.nvim', 'null-ls.nvim', 'asciitree.nvim'}, { event = "BufRead *" }, _G.packer_plugins)]]
