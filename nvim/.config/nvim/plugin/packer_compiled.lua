...
_G.packer_plugins = {
  ...
  ["nvim-cmp"] = {
    after = { "cmp-buffer", "cmp-nvim-lua", "cmp-path", "cmp_luasnip", "nvim-autopairs", "cmp-spell" },
...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'mason.nvim', 'nvim-treesitter', 'null-ls.nvim', 'nvim-surround', 'nvim-cmp', 'gitsigns.nvim', 'Comment.nvim', 'asciitree.nvim'}, { event = "BufRead *" }, _G.packer_plugins)]]
vim.cmd [[au BufEnter * ++once lua require("packer.load")({'nvim-tree.lua', 'lualine.nvim'}, { event = "BufEnter *" }, _G.packer_plugins)]]
vim.cmd [[au CursorHold * ++once lua require("packer.load")({'telescope.nvim', 'vim-fugitive', 'colorizer'}, { event = "CursorHold *" }, _G.packer_plugins)]]
