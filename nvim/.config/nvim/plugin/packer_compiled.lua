...
_G.packer_plugins = {
  ...
  ["nvim-cmp"] = {
    after = { "cmp-buffer", "nvim-autopairs", "cmp-nvim-lua", "cmp-path", "cmp-spell", "cmp_luasnip" },
...
vim.cmd [[au CursorHold * ++once lua require("packer.load")({'colorizer', 'vim-fugitive', 'telescope.nvim'}, { event = "CursorHold *" }, _G.packer_plugins)]]
vim.cmd [[au BufRead * ++once lua require("packer.load")({'nvim-surround', 'nvim-cmp', 'gitsigns.nvim', 'Comment.nvim', 'asciitree.nvim', 'mason.nvim', 'null-ls.nvim', 'nvim-treesitter'}, { event = "BufRead *" }, _G.packer_plugins)]]
