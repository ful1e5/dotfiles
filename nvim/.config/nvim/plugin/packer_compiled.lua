...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'Comment.nvim', 'asciitree.nvim', 'vim-fugitive', 'mason.nvim', 'null-ls.nvim', 'nvim-cmp', 'nvim-surround', 'gitsigns.nvim', 'nvim-treesitter'}, { event = "BufRead *" }, _G.packer_plugins)]]
