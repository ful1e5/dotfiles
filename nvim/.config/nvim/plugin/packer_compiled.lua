...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'Comment.nvim', 'asciitree.nvim', 'nvim-cmp', 'mason.nvim', 'null-ls.nvim', 'nvim-surround', 'nvim-treesitter', 'vim-fugitive', 'gitsigns.nvim'}, { event = "BufRead *" }, _G.packer_plugins)]]
