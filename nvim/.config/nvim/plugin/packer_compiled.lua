...
_G.packer_plugins = {
  ...
  ["nvim-cmp"] = {
    after = { "cmp-buffer", "nvim-autopairs", "cmp-nvim-lua", "cmp_luasnip", "cmp-path" },
...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'gitsigns.nvim', 'asciitree.nvim', 'mason.nvim', 'null-ls.nvim', 'nvim-cmp', 'Comment.nvim', 'nvim-surround', 'vim-fugitive', 'nvim-treesitter'}, { event = "BufRead *" }, _G.packer_plugins)]]
