...
_G.packer_plugins = {
  ...
  ["fidget.nvim"] = {
    config = { "\27LJ\2\n\1\0\0\4\0\b\0\v6\0\0\0'\2\1\0B\0\2\0029\0\2\0005\2\4\0005\3\3\0=\3\5\0025\3\6\0=\3\a\2B\0\2\1K\0\1\0\vwindow\1\0\1\vborder\frounded\ttext\1\0\0\1\0\2\fspinner\19square_corners\tdone\t ï€Œ\nsetup\vfidget\frequire\0" },
    loaded = true,
  ...
  ["nvim-cmp"] = {
    after = { "cmp-buffer", "cmp-nvim-lua", "cmp_luasnip", "nvim-autopairs", "cmp-path" },
  ...
  ["nvim-tree.lua"] = {
    ...
    needs_bufread = false,
    only_cond = false,
    path = "/home/ful1e5/.local/share/nvim/site/pack/packer/opt/nvim-tree.lua",
...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'asciitree.nvim', 'mason.nvim', 'null-ls.nvim', 'nvim-treesitter', 'Comment.nvim', 'vim-fugitive', 'nvim-cmp', 'gitsigns.nvim', 'nvim-surround'}, { event = "BufRead *" }, _G.packer_plugins)]]
