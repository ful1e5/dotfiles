...
_G.packer_plugins = {
  ...
  ["impatient.nvim"] = {
    ...
    loaded = true,
    path = "/home/kaiz/.local/share/nvim/site/pack/packer/start/impatient.nvim",
  ...
  ["nvim-cmp"] = {
    after = { "cmp-buffer", "cmp-nvim-lua", "nvim-autopairs", "cmp-path", "cmp_luasnip", "cmp-spell" },
  ...
  ["nvim-treesitter"] = {
    after = { "nvim-autopairs", "playground", "nvim-ts-autotag" },
...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'mason.nvim', 'nvim-cmp', 'nvim-surround', 'gitsigns.nvim', 'null-ls.nvim', 'Comment.nvim', 'vim-fugitive', 'nvim-treesitter', 'asciitree.nvim'}, { event = "BufRead *" }, _G.packer_plugins)]]
