...
_G.packer_plugins = {
  ...
  ["nvim-cmp"] = {
    after = { "cmp-buffer", "nvim-autopairs", "cmp-path", "cmp-nvim-lua", "cmp_luasnip" },
...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'gitsigns.nvim', 'asciitree.nvim', 'mason.nvim', 'null-ls.nvim', 'vim-fugitive', 'nvim-surround', 'Comment.nvim', 'nvim-treesitter', 'nvim-cmp'}, { event = "BufRead *" }, _G.packer_plugins)]]
