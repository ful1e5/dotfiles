...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'mason.nvim', 'null-ls.nvim', 'asciitree.nvim', 'nvim-surround', 'nvim-cmp', 'nvim-treesitter', 'vim-fugitive', 'gitsigns.nvim', 'Comment.nvim'}, { event = "BufRead *" }, _G.packer_plugins)]]
