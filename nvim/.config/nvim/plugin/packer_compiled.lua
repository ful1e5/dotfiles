...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'nvim-surround', 'vim-fugitive', 'gitsigns.nvim', 'Comment.nvim', 'nvim-cmp', 'asciitree.nvim', 'mason.nvim', 'null-ls.nvim', 'nvim-treesitter'}, { event = "BufRead *" }, _G.packer_plugins)]]
