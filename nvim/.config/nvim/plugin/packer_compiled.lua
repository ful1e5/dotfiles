...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'nvim-treesitter', 'null-ls.nvim', 'nvim-surround', 'nvim-cmp', 'mason.nvim', 'Comment.nvim', 'gitsigns.nvim', 'asciitree.nvim', 'vim-fugitive'}, { event = "BufRead *" }, _G.packer_plugins)]]
