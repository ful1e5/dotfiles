...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'nvim-surround', 'gitsigns.nvim', 'Comment.nvim', 'asciitree.nvim', 'mason.nvim', 'null-ls.nvim', 'nvim-treesitter', 'nvim-cmp', 'vim-fugitive'}, { event = "BufRead *" }, _G.packer_plugins)]]
